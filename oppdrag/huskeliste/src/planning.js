let maxTasksPerDay = 5;
let maxPhyiscalTasksPerDay = 2;
let maxBoringTasksPerDay = 2;
...
function parseWeek(dateStr) {
   ...
   let week = parseInt(dateStr.split('-')[1]);
   let day = parseInt(dateStr.split('-')[2]);
   return Date(year,week,day).getWeek();
}
