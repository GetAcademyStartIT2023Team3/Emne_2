...
const model = {
     ...
     *     En uke har en artikkel per dag
     *     En artikkel tilhører et tema og består av flere atomer
     ...
     */
    ukeplan: [
        { uke: 1, artikler: {mandag: [4, 3], tirsdag: 1, onsdag: 5, /*etc*/} },
        { uke: 2, artikler: {mandag: 5, tirsdag: 2, onsdag: 6, /*etc*/} },
        { uke: 10, artikler: {mandag: 5, tirsdag: 2, onsdag: 6, torsdag: 12, /*etc*/} },
    ],
