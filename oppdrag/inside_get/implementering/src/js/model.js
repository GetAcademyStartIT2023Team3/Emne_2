...
const model = {
    ...
    atoms: [
       ...
       { id: 3,  type: 'imageAsset',  title: 'En pomodoro tomat', text: 'Dette er en pomodoro-timer, den kan hjelpe deg med pomodoro-teknikken blabla..', ref: './assets/image/pomodoro_timer.png' },
